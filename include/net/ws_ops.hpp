...
// namespace wsops — shared WebSocket/TLS operations used by both sync and async
// sessions: resolve/connect, TLS/WS handshakes, socket options, and small
// helpers. Consolidates common code and keeps session classes focused on I/O.
namespace wsops {
