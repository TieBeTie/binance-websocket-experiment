...
// namespace io — small file write helpers used by logging components.
// Provides blocking write(2)/writev(2) loops that handle EINTR/EAGAIN and
// partial writes. Kept separate to avoid duplication and keep hot paths tight.
namespace io {
